...
The Python Script requires the EoL_dataset_for_MC.csv to run the case study for Methylene Chloride which is in the folder output. The EoL_dataset_for_MC.csv is composed of the following data entries according to Table S2 in the Supporting Information for the abovementioned journal paper:
